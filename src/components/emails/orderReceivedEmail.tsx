...
const orderReceivedEmail = ({
    ...
    const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://casecreations.vercel.app"

    return (
        <Html>
            <Head />
            <Preview>Your order summary and approximate delivery date</Preview>
            <Body style={main}>
                <Container style={container}>
                    <Section style={message}>
                        <Img src={`${baseUrl}/snake-3.png`} width="65" height="73" alt="delivery guy" style={{ margin: "auto" }} />
                        <Heading style={global.heading}>
                            Thank you for ordering!
                        </Heading>
                        <Text style={global.text}>
                            We've received your order and are preparing everything for delivery.
                    ...
                    <Section style={paddingY}>
                        ...
                        <Row>
                            <Text style={footer.text}>
                                © CaseCreations Inc. All Rights Reserved
                            </Text>
                        </Row>
                    </Section>
                </Container>
