...
import { ArrowRight, Check, ChevronsUpDown, Users } from "lucide-react";
...
const DesignConfigurator = ({ configId, imageUrl, imageDimensions }: DesignConfiguratorProps) => {
    ...
    //mutation to save cropped image and update db
    ...
    const [redneredDimensions, setRenderedDimension] = useState({
    ...
    async function saveConfiguration() {
        try {
            ...
            context?.drawImage(
                ...
                actualX,
                actualY,
                redneredDimensions.width,
                redneredDimensions.height
            )
    ...
    return (
        <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
            <div ref={containerRef} className="relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-;g
            ...
            <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
                <ScrollArea className="relative flex-1 overflow-auto">
                    <div aria-hidden="true" className="absolute z-10 inset-x-0 bottom-0 h-12 bg-gradient-to-t 
                                                ...
                                                {selectableOptions.map((option) => (
                                                    <RadioGroup.Option
                                                        ...
                                                        className={({ active, checked }) =>
                                                            cn("relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify justify-between",
                                                        ...
                                                        <span className="flex items-center">
                                                            <span className="flex flex-col text-sm">
                                                                ...
                                                                {option.description
                                                                    ? <RadioGroupDescription as="span" className="text-gray-500">
