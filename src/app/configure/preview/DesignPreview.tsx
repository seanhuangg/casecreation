        ...
        <>
            ...
            <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
                <div className="md:col-span-3 md:row-span-2 md:row-end-2">
                    <CustomPhone className={cn(`bg-${tw}`, "max-w=[150px] md:max-w-full")} imgSrc={configuration?.croppedImageUrl!} />
                </div>

                <div className="mt-6 sm:col-span-9 md:row-end-1">
                    <h3 className="text-3xl font-bold tracking-tight text-gray-900">Your Custom {modelLabel} Case is almost ready!</h3>
